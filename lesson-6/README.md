...
4. [setTimeout и setInterval](https://learn.javascript.ru/settimeout-setinterval)
5. [Объект функции, NFE](https://learn.javascript.ru/function-object)
6. [Преобразование объектов в примитивы](https://learn.javascript.ru/object-toprimitive)